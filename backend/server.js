...
const pageRoutes = { '/': 'index.html', '/login': 'index.html', '/signup': 'signup.html', '/dashboard': 'dashboard.html', '/meetings': 'meetings.html', '/tasks': 'tasks.html', '/team': 'team.html', '/performance': 'performance.html', '/reports': 'reports.html', '/notifications': 'notifications.html', '/settings': 'settings.html', '/meeting-room': 'meeting-room.html' };
